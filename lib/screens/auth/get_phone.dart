...
import 'package:foodie_bunny/screens/auth/select_country.dart';
import 'package:foodie_bunny/screens/auth/verify.dart';
import 'package:foodie_bunny/screens/auth_page.dart';
import 'package:foodie_bunny/utils/constants.dart';
...
class _PhoneAuthGetPhoneState extends State<PhoneAuthGetPhone> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: 
      // WillPopScope(
      //   onWillPop: () => _onBack(), //_deleteOnPop(),
      //   child: 
        SafeArea(
          child: Stack(
            children: <Widget>[
  ...
  Widget _getBody(CountryProvider countriesProvider) => Card(
        color: Colors.orange, //widget.cardBackgroundColor,
        elevation: 2.0,
        shape:
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: PhoneAuthWidgets.getLogo(
                logoPath: 'assets/images/lion_food.png', //widget.logo,
                height: _height * 0.15),
          ),

          // AppName:
          Text("Foodie Sher", //widget.appName,
           ...
           */
          SizedBox(height: _fixedPadding * 1.2),
          RaisedButton(
            //elevation: 8.0,
